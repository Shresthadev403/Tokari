      ...
      <div className="container mx-auto px-4 sm:px-8 dark:bg-gray-700 dark:border-gray-700">
        <div className="py-8">
          ...
          <div className="relative flex">
                <select className=" h-max rounded-l border block appearance-none w-full bg-white border-gray-400 text-gray-700 py-2 px-4 pr-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500  dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                  <option>Sort by </option>
                  <option>Most Sold</option>
                  <option>Least Sold</option>
                </select>
                <select className=" h-max rounded-l border block appearance-none w-fit bg-white border-gray-400 text-gray-700 py-2 px-4 pr-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500  dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                  <option>Current Month </option>
                  <option>Last Month</option>
                  <option>Last Year</option>
                  <option>Up to now</option>
                </select>
              </div>
          </div>
              ...
              <table className="min-w-full leading-normal">
                <thead>
                  <tr>
                    ...
                    <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider  dark:bg-gray-800 dark:border-gray-100 dark:text-white">
                      Revenue<span className="normal-case">(NRs)</span>
                    </th>
                    <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider  dark:bg-gray-800 dark:border-gray-100 dark:text-white">
                      Details
                    </th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm  dark:bg-gray-800 dark:border-gray-700">
                      <Link to={`/Dashboard/Product/123`} className=" font-medium mx-2 whitespace-no-wrap  text-blue-700  dark:text-blue-500">
                        View
                      </Link>
                    </td>
                  </tr>
