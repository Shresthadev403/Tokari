function Notification() {
  return (
    <div className="dark:bg-gray-700 dark:text-white ">
      <div className="flex items-center justify-between dark:bg-gray-800 dark:text-white pt-2 pb-2 ">
        <p className="text-2xl font-semibold leading-6 text-gray-800 dark:bg-gray-800 dark:text-white">Today</p>
      </div>
      <div className="w-full p-3  border-t bg-white rounded flex dark:bg-gray-800 dark:text-white">
        <div className="w-8 h-8 border rounded-full border-gray-200 flex items-center justify-center dark:bg-gray-800 dark:text-white">
          <svg
            width={16}
            height={16}
            viewBox="0 0 16 16"
        ...
        <div className="pl-3">
          <p className="text-sm leading-none">
            <span className="text-indigo-600">James Doe</span> favourited an{" "}
            <span className="text-indigo-600">item</span>
          </p>
          <p className="text-xs leading-3 pt-1 text-gray-500 dark:text-white">2 hours ago</p>
        </div>
      </div>
      <div className="w-full p-3  border-t bg-white rounded shadow flex flex-shrink-0 dark:bg-gray-800 dark:text-white">
      ...
      <div className="w-full p-3 border-t bg-red-100 rounded flex items-center dark:bg-gray-800 dark:text-white">
        ...
        <div className="pl-3 w-full flex items-center justify-between">
          ...
          <p className="text-xs leading-3 cursor-pointer underline text-right text-red-500">
            Manage
          </p>
        </div>
      </div>
      <div className="w-full p-3 border-t bg-white rounded flex dark:bg-gray-800 dark:text-white">
        ...
        <div className="pl-3 dark:bg-gray-800 dark:text-white">
          <p className="text-sm leading-none dark:bg-gray-800 dark:text-white">
            Shipmet delayed for order
            <span className="text-indigo-600"> #25551</span>
          </p>
          <p className="text-xs leading-3 pt-1 text-gray-500  dark:text-white">2 hours ago</p>
        </div>
      </div>
      <h2 className="text-md font-bold leading-normal pt-4 border-b pb-2 border-gray-300 text-gray-900 dark:bg-gray-800 dark:text-white">
        YESTERDAY
      </h2>
      <div className="w-full p-3  border-t bg-white rounded flex dark:bg-gray-800 dark:text-white">
        <div className="w-8 h-8 border rounded-full border-gray-200 flex items-center justify-center dark:bg-gray-800 dark:text-white">
      ...
      <div className="w-full p-3 border-t bg-green-100 rounded flex items-center dark:bg-gray-800 dark:text-white">
        ...
        <div className="pl-3 w-full">
          <div className="flex items-center justify-between">
            ...
            <p className="text-xs leading-3 underline cursor-pointer text-green-600">
              View
            </p>
          </div>
        </div>
