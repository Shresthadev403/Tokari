...
function UserHistoryTable() {
    return (   <div className=" w-full bg-gray-100 text-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
    {/* table component */}
    <div className="container    dark:bg-gray-700 dark:border-gray-700">
      <div className="py-2">
        <div>
          <h2 className="text-2xl mb-1 font-semibold leading-tight dark:text-white">
            User History
          </h2>
        </div>
            ...
            <table className="min-w-full leading-normal">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm  dark:bg-gray-800 dark:border-gray-700">
                    <Link to={`/Dashboard/Order/123`} className="font-medium mx-2 whitespace-no-wrap  text-blue-700 hover:underline dark:text-blue-500">
                      Edit
                    </Link>
                  </td>
                </tr>
