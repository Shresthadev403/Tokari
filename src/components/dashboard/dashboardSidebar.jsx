...
const dashBoardItemList1=[
  
];
const dashBoardItemList2=[];
      ...
      <aside className=" w-14 md:w-48 lg:w-64 " aria-label="Sidebar">
        <div className="min-h-screen overflow-y-auto py-4 px-3 bg-gray-50  dark:bg-gray-800">
          ...
          <li>
            ...
            <li>
              <Link to={'/Dashboard/Kanban'} className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <li>
              <Link to={`/Dashboard/Products`} className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <li>
              <Link to={`/Dashboard/Orders`} className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
