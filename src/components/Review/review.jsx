...
function Review() {
    return ( <div className=" p-6 bg-white border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    <article>
      <div className="flex items-center mb-4 space-x-4">
        <img className="w-10 h-10 rounded-full" src={dempPorfileImage} alt="" />
