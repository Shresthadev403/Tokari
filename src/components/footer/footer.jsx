...
const Footer = () => {
  return (
    <div className="relative w-full  py-2 bg-gray-200 dark:bg-black dark:text-white">
      <div className="flex flex-col items-center justify-center  dark:bg-black dark:text-white">
        {/* <div>
        <img src={tokariLogo} alt="logo" className="object-contain h-40 w-80 " />
        </div> */}
        <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-6  dark:bg-black dark:text-white">
        <div className=" relative md:absolute md:left-0    ">
        <img src={tokariLogo} alt="logo" className="object-contain h-40 w-80  " />
        </div>
          <p className="hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-800 dark:bg-black dark:text-white ">
            About
          </p>
          <p className="hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-800  dark:bg-black dark:text-white">
            Contact us
        ...
        <div className="flex items-center gap-x-8 mt-2  dark:bg-black dark:text-white">
          <div className="cursor-pointer  dark:bg-black dark:text-white">
            <svg
              className="fill-current text-gray-800 hover:text-gray-500  dark:bg-black dark:text-white"
              width="22"
              height="22"
              viewBox="0 0 22 22"
              fill="none"
        ...
        <div className="flex items-center mt-4  dark:bg-black dark:text-white">
          <p className="text-base leading-4 text-gray-800  dark:bg-black dark:text-white">
            2022 <span className="font-semibold  dark:bg-black dark:text-white">Tokari</span>
          </p>
          <div className="border-l border-gray-800 pl-2 ml-2  dark:bg-black dark:text-white">
            <p className="text-base leading-4 text-gray-800  dark:bg-black dark:text-white">
